...
public class DeleteBandFX implements Initializable, FileUtils {
    @FXML
    ...
    public void deleteBand(ActionEvent actionEvent) {
        ...
        for (int i = 0; i < data.size(); i++) {
            if (data.get(i).contains(listBand.getSelectionModel().getSelectedItem())) {
                data.remove(listBand.getSelectionModel().getSelectedItem());
